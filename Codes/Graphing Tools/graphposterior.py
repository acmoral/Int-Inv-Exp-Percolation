...
data = pd.read_csv(r"C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\Results\30x5FC\p_inf\pinf_30x5FC.csv", na_filter= False)
display(data)
...
ax2.plot(logs_real,pinf_log,marker='D',ls='',ms=7,markerfacecolor="None", markeredgewidth=2,color='black')
ax1.plot(logs_ideal,pinf_log,marker='D',ls='',ms=7,markerfacecolor="None", markeredgewidth=2,color='black')
