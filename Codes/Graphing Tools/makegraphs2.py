...
#---------------------p=0,A=3mm----------------------------------------
df = pd.read_csv(r'C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\excel\p=0,05A=4mmH=2mm.csv')
y=df['y']
height=-y[::3]*100
si=len(height)
...
#---------------------p=0,05,A=3mm,H=1mm----------------------------------------
df = pd.read_csv(r'C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\excel\p=0,15A=4mmH=2mm.csv')
y=df['y']
height=-y[::4]*100
si=len(height)
weight=np.linspace(0,si,si)*15.64+66.4
