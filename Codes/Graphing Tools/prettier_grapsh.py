...
data = pd.read_csv(
    r"C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\Circular\excel\mismo_desplazamiento.csv",
    na_filter=False,
)
display(data)
p = np.array(data["p"])
...
ax1.plot(
    logs_p, logs_w, linestyle="", marker="o", markersize=9, color="black", mfc="red"
)
