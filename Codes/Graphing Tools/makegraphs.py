...
#---------------------p=0,A=3mm----------------------------------------
df = pd.read_csv(r'C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\excel\p=0A=3mm.csv')
y=df['y']
height=-y[::3]*100
si=len(height)
...
#---------------------p=0,05A=3mmH=1mm----------------------------------------
df = pd.read_csv(r'C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\excel\p=0,05A=3mmH=1mm.csv')
y=df['y']
height=-y[::4]*100
height=height[:39]
si=len(height)
...
#---------------------p=0,1,A=3mm,H=1mm----------------------------------------
df = pd.read_csv(r'C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\excel\p=0,1A=3mmH=1mm.csv')
y=df['y']
height=-y[::4]*100
si=len(height)
weight=np.linspace(0,si,si)*15.64+76.7-15.64
...
weight[1]=0
weight=weight*980 #gravity
ax1.errorbar(weight,height,marker='^',ls=' ',ms=9,label= 'P=0.1',color='darkmagenta')
ax2.errorbar(weight,height,marker='^',ls=' ',ms=9,label= 'P=0.1',color='darkmagenta')
#--------------------p=0,1A=3mmH=1mm LR--------------------------------------
X =np.array(weight).reshape(-1,1) 
...
weight[0]=0
weight=weight*980 #gravity
ax1.errorbar(weight,height,marker='D',ls=' ',ms=9,label= 'P=0.15',color='royalblue')
ax2.errorbar(weight,height,marker='D',ls=' ',ms=9,label= 'P=0.15',color='royalblue')
#--------------------p=0,15A=3mmH=1mm LR--------------------------------------
X =np.array(weight).reshape(-1,1) 
...
#---------------------p=0,2,A=3mm,H=1mm----------------------------------------
df = pd.read_csv(r'C:\Users\Carolina\OneDrive\Escritorio\Int inv Exp\videos y fotos medidas\excel\p=0,2A=3mmH=1mm.csv')
y=df['y']
height=-y[::4]*100
si=len(height)
weight=np.linspace(0,si,si)*15.64+76.7-15.64
